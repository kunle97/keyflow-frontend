...
import { createRentalApplication } from "../../api/api";
  ...
  return (
    <div className="container-fluid">
      <div className="row">
        ...
        >
          <div>
            <h2>Rental Application for [Unit/Property]</h2>
                            ...
                            removeBtn={
                              index !== 0 && (
                                <Button
                                  ...
                                  variant="contained"
                                  onClick={() => removeRentalHistoryNode(index)}
                                >
                                  Remove
                                </Button>
                              )
